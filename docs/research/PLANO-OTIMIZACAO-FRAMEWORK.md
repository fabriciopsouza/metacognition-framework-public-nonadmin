...
> **O que é:** documento único e autossuficiente para conduzir esta rodada de
> otimização do `metacognition-framework`. Substitui qualquer KICKOFF anterior
> (que estava inflado). Lê-se uma vez; executa-se com gate humano.
> **Status:** aberto · **Base:** chat 2026-05-26 + pesquisas Claude/Gemini ·
> **Regra-mãe:** só aplicar o que for **otimização líquida**. PT-BR. Empregador
> do setor de energia citado genericamente.
