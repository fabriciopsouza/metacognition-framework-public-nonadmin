...
3. Ele abre um **PR para o repo master** (`fabriciopsouza/metacognition-framework-public-nonadmin`). **Esse PR É o consentimento** — ato explícito, informado e específico (LGPD Art. 8, embora o dado já seja não-pessoal). **Nenhuma transmissão automática.**
