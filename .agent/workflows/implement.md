...
## Pré-requisito
ADR aceito + aceite com critérios binários (Parte B de `docs/specs/<feature>/spec.md`, ou `validation.md`)
...
- Limite: circuit breaker de QA (ADR-118); grave toda rodada, inclusive reprovação.
