...
| `PROMPT-CHAT-WEB-v4.5.md` (raiz) | instruções p/ colar no Claude.ai chat — encarnação do framework para ambientes sem filesystem (mesmos princípios, mesmos resultados, papéis/subagentes simulados) |
