...
HOOK_PY = os.path.join(ROOT, "tools", "hooks", "compaction_gate.py")
HOOK_PS = os.path.join(ROOT, "tools", "hooks", "compaction-gate.ps1")


def find_runner():
    """Python-first (ADR-060 pattern). Falls back to PS if Python port absent."""
