...
def main():
    fails = []
    SSH = "git@github.com:fabriciopsouza/metacognition-framework-public-nonadmin.git"
    HTTPS = "https://github.com/fabriciopsouza/metacognition-framework-public-nonadmin"
    ...
    if _norm_remote(SSH) != "github.com/fabriciopsouza/metacognition-framework-public-nonadmin":
