...
HOOK_PY = os.path.join(ROOT, "tools", "hooks", "effect_gate.py")
HOOK_PS = os.path.join(ROOT, "tools", "hooks", "effect-gate.ps1")
...
def run_hook(runner, tool, command):
